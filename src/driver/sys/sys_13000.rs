...
pub struct Lib {
    ...
    pub cuDeviceGetAttribute: Result<
        ...
        ::libloading::Error,
    >,
    pub cuDeviceGetHostAtomicCapabilities: Result<
        unsafe extern "C" fn(
    ...
    pub cuMemcpy3DPeerAsync: Result<
        ...
        ::libloading::Error,
    >,
    pub cuMemcpyBatchAsync_v2: Result<
        unsafe extern "C" fn(
        ...
        ::libloading::Error,
    >,
    pub cuMemcpy3DBatchAsync_v2: Result<
        unsafe extern "C" fn(
            numOps: usize,
    ...
    pub cuMemGetDefaultMemPool: Result<
        unsafe extern "C" fn(
    ...
    pub cuMemAdvise_v2: Result<
        ...
        ::libloading::Error,
    >,
    pub cuMemPrefetchBatchAsync: Result<
        unsafe extern "C" fn(
        ...
        ::libloading::Error,
    >,
    pub cuMemDiscardBatchAsync: Result<
        unsafe extern "C" fn(
            dptrs: *mut CUdeviceptr,
            sizes: *mut usize,
            count: usize,
        ...
        ::libloading::Error,
    >,
    pub cuMemDiscardAndPrefetchBatchAsync: Result<
        unsafe extern "C" fn(
            dptrs: *mut CUdeviceptr,
            sizes: *mut usize,
            count: usize,
    ...
    pub cuDeviceGetP2PAttribute: Result<
        ...
        ::libloading::Error,
    >,
    pub cuDeviceGetP2PAtomicCapabilities: Result<
        unsafe extern "C" fn(
            capabilities: *mut ::core::ffi::c_uint,
            operations: *const CUatomicOperation,
            count: ::core::ffi::c_uint,
    ...
    pub cuGreenCtxGetId: Result<
        ...
        ::libloading::Error,
    >,
    pub cuLogsRegisterCallback: Result<
        unsafe extern "C" fn(
        ...
        ::libloading::Error,
    >,
    pub cuLogsUnregisterCallback: Result<
        unsafe extern "C" fn(callback: CUlogsCallbackHandle) -> CUresult,
        ::libloading::Error,
    >,
    pub cuLogsCurrent: Result<
        unsafe extern "C" fn(
...
impl Lib {
        ...
        L: Into<::libloading::Library>,
    {
        ...
        let cuCtxGetDevice_v2 = __library.get(b"cuCtxGetDevice_v2\0").map(|sym| *sym);
        ...
        let cuCtxSynchronize_v2 = __library.get(b"cuCtxSynchronize_v2\0").map(|sym| *sym);
        ...
        let cuMemcpyBatchAsync_v2 = __library.get(b"cuMemcpyBatchAsync_v2\0").map(|sym| *sym);
        let cuMemcpy3DBatchAsync_v2 = __library.get(b"cuMemcpy3DBatchAsync_v2\0").map(|sym| *sym);
        ...
        let cuMemGetDefaultMemPool = __library.get(b"cuMemGetDefaultMemPool\0").map(|sym| *sym);
        let cuMemGetMemPool = __library.get(b"cuMemGetMemPool\0").map(|sym| *sym);
        let cuMemSetMemPool = __library.get(b"cuMemSetMemPool\0").map(|sym| *sym);
        ...
        let cuMemPrefetchBatchAsync = __library.get(b"cuMemPrefetchBatchAsync\0").map(|sym| *sym);
        let cuMemDiscardBatchAsync = __library.get(b"cuMemDiscardBatchAsync\0").map(|sym| *sym);
        ...
        let cuGreenCtxGetId = __library.get(b"cuGreenCtxGetId\0").map(|sym| *sym);
        let cuLogsRegisterCallback = __library.get(b"cuLogsRegisterCallback\0").map(|sym| *sym);
        let cuLogsUnregisterCallback = __library.get(b"cuLogsUnregisterCallback\0").map(|sym| *sym);
        let cuLogsCurrent = __library.get(b"cuLogsCurrent\0").map(|sym| *sym);
        let cuLogsDumpToFile = __library.get(b"cuLogsDumpToFile\0").map(|sym| *sym);
        let cuLogsDumpToMemory = __library.get(b"cuLogsDumpToMemory\0").map(|sym| *sym);
    ...
    pub unsafe fn cuDeviceGetHostAtomicCapabilities(
        ...
        (self
            .cuDeviceGetHostAtomicCapabilities
            .as_ref()
            .expect("Expected function, got error."))(capabilities, operations, count, dev)
    }
    ...
    pub unsafe fn cuCtxGetDevice_v2(&self, device: *mut CUdevice, ctx: CUcontext) -> CUresult {
        (self
            .cuCtxGetDevice_v2
            .as_ref()
            .expect("Expected function, got error."))(device, ctx)
    }
    ...
    pub unsafe fn cuCtxSynchronize_v2(&self, ctx: CUcontext) -> CUresult {
        (self
            .cuCtxSynchronize_v2
            .as_ref()
            .expect("Expected function, got error."))(ctx)
    ...
    pub unsafe fn cuMemcpy3DBatchAsync_v2(
        ...
        (self
            .cuMemcpy3DBatchAsync_v2
            .as_ref()
            .expect("Expected function, got error."))(numOps, opList, flags, hStream)
    }
    ...
    pub unsafe fn cuMemGetDefaultMemPool(
        ...
        (self
            .cuMemGetDefaultMemPool
            .as_ref()
            .expect("Expected function, got error."))(pool_out, location, type_)
    }
    pub unsafe fn cuMemGetMemPool(
        ...
        (self
            .cuMemGetMemPool
            .as_ref()
            .expect("Expected function, got error."))(pool, location, type_)
    }
    pub unsafe fn cuMemSetMemPool(
        ...
        (self
            .cuMemSetMemPool
            .as_ref()
            .expect("Expected function, got error."))(location, type_, pool)
    }
    ...
    pub unsafe fn cuMemDiscardBatchAsync(
        ...
        (self
            .cuMemDiscardBatchAsync
            .as_ref()
            .expect("Expected function, got error."))(dptrs, sizes, count, flags, hStream)
    }
    ...
    pub unsafe fn cuGreenCtxGetId(
        ...
        (self
            .cuGreenCtxGetId
            .as_ref()
            .expect("Expected function, got error."))(greenCtx, greenCtxId)
    }
    pub unsafe fn cuLogsRegisterCallback(
        ...
        (self
            .cuLogsRegisterCallback
            .as_ref()
            .expect("Expected function, got error."))(callbackFunc, userData, callback_out)
    }
    pub unsafe fn cuLogsUnregisterCallback(&self, callback: CUlogsCallbackHandle) -> CUresult {
        (self
            .cuLogsUnregisterCallback
            .as_ref()
    ...
    pub unsafe fn cuLogsCurrent(
        ...
        (self
            .cuLogsCurrent
            .as_ref()
            .expect("Expected function, got error."))(iterator_out, flags)
    }
    pub unsafe fn cuLogsDumpToFile(
        ...
        (self
            .cuLogsDumpToFile
            .as_ref()
            .expect("Expected function, got error."))(iterator, pathToFile, flags)
    }
    pub unsafe fn cuLogsDumpToMemory(
        ...
        (self
            .cuLogsDumpToMemory
            .as_ref()
            .expect("Expected function, got error."))(iterator, buffer, size, flags)
    }
