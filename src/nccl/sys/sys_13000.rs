...
pub struct Lib {
    ...
    pub ncclCommDeregister: Result<
        ...
        ::libloading::Error,
    >,
    pub ncclCommWindowRegister: Result<
        unsafe extern "C" fn(
            comm: ncclComm_t,
            buff: *mut ::core::ffi::c_void,
            size: usize,
        ...
        ::libloading::Error,
    >,
    pub ncclCommWindowDeregister: Result<
...
impl Lib {
        ...
        L: Into<::libloading::Library>,
    {
        ...
        let ncclCommShrink = __library.get(b"ncclCommShrink\0").map(|sym| *sym);
        ...
        let ncclCommWindowRegister = __library.get(b"ncclCommWindowRegister\0").map(|sym| *sym);
        let ncclCommWindowDeregister = __library.get(b"ncclCommWindowDeregister\0").map(|sym| *sym);
    ...
    pub unsafe fn ncclCommWindowRegister(
        ...
        (self
            .ncclCommWindowRegister
            .as_ref()
            .expect("Expected function, got error."))(comm, buff, size, win, winFlags)
    }
    pub unsafe fn ncclCommWindowDeregister(
        &self,
        comm: ncclComm_t,
        win: ncclWindow_t,
    ) -> ncclResult_t {
        (self
            .ncclCommWindowDeregister
            .as_ref()
            .expect("Expected function, got error."))(comm, win)
    }
