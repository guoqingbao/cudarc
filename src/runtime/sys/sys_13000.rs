...
pub struct Lib {
    ...
    pub cudaDeviceGetAttribute: Result<
        ...
        ::libloading::Error,
    >,
    pub cudaDeviceGetHostAtomicCapabilities: Result<
        unsafe extern "C" fn(
    ...
    pub cudaDeviceGetP2PAttribute: Result<
        ...
        ::libloading::Error,
    >,
    pub cudaDeviceGetP2PAtomicCapabilities: Result<
        unsafe extern "C" fn(
            capabilities: *mut ::core::ffi::c_uint,
            operations: *const cudaAtomicOperation,
            count: ::core::ffi::c_uint,
    ...
    pub cudaImportExternalSemaphore: Result<
        ...
        ::libloading::Error,
    >,
    pub cudaSignalExternalSemaphoresAsync: Result<
        unsafe extern "C" fn(
        ...
        ::libloading::Error,
    >,
    pub cudaWaitExternalSemaphoresAsync: Result<
        unsafe extern "C" fn(
            extSemArray: *const cudaExternalSemaphore_t,
    ...
    pub cudaMemPrefetchAsync: Result<
        ...
        ::libloading::Error,
    >,
    pub cudaMemPrefetchBatchAsync: Result<
        unsafe extern "C" fn(
        ...
        ::libloading::Error,
    >,
    pub cudaMemDiscardBatchAsync: Result<
        unsafe extern "C" fn(
            dptrs: *mut *mut ::core::ffi::c_void,
            sizes: *mut usize,
            count: usize,
        ...
        ::libloading::Error,
    >,
    pub cudaMemDiscardAndPrefetchBatchAsync: Result<
        unsafe extern "C" fn(
            dptrs: *mut *mut ::core::ffi::c_void,
            sizes: *mut usize,
            count: usize,
    ...
    pub cudaMemGetDefaultMemPool: Result<
        unsafe extern "C" fn(
            memPool: *mut cudaMemPool_t,
            location: *mut cudaMemLocation,
    ...
    pub cudaRuntimeGetVersion: Result<
        ...
        ::libloading::Error,
    >,
    pub cudaLogsRegisterCallback: Result<
        unsafe extern "C" fn(
        ...
        ::libloading::Error,
    >,
    pub cudaLogsUnregisterCallback: Result<
        unsafe extern "C" fn(callback: cudaLogsCallbackHandle) -> cudaError_t,
        ::libloading::Error,
    >,
    pub cudaLogsCurrent: Result<
        unsafe extern "C" fn(
    ...
    pub cudaLogsDumpToFile: Result<
        ...
        ::libloading::Error,
    >,
    pub cudaLogsDumpToMemory: Result<
        unsafe extern "C" fn(
            iterator: *mut cudaLogIterator,
...
impl Lib {
        ...
        L: Into<::libloading::Library>,
    {
        ...
        let cudaMemPrefetchBatchAsync = __library
            ...
            .map(|sym| *sym);
        let cudaMemDiscardBatchAsync = __library.get(b"cudaMemDiscardBatchAsync\0").map(|sym| *sym);
        ...
        let cudaMemGetDefaultMemPool = __library.get(b"cudaMemGetDefaultMemPool\0").map(|sym| *sym);
        let cudaMemGetMemPool = __library.get(b"cudaMemGetMemPool\0").map(|sym| *sym);
        let cudaMemSetMemPool = __library.get(b"cudaMemSetMemPool\0").map(|sym| *sym);
        ...
        let cudaLogsRegisterCallback = __library.get(b"cudaLogsRegisterCallback\0").map(|sym| *sym);
        let cudaLogsUnregisterCallback = __library
            .get(b"cudaLogsUnregisterCallback\0")
            .map(|sym| *sym);
        let cudaLogsCurrent = __library.get(b"cudaLogsCurrent\0").map(|sym| *sym);
        let cudaLogsDumpToFile = __library.get(b"cudaLogsDumpToFile\0").map(|sym| *sym);
        let cudaLogsDumpToMemory = __library.get(b"cudaLogsDumpToMemory\0").map(|sym| *sym);
    ...
    pub unsafe fn cudaDeviceGetHostAtomicCapabilities(
        ...
        (self
            ...
            .as_ref()
            .expect("Expected function, got error."))(
            capabilities, operations, count, device
        )
    }
    ...
    pub unsafe fn cudaMemcpy3DBatchAsync(
        ...
        (self
            .cudaMemcpy3DBatchAsync
            .as_ref()
            .expect("Expected function, got error."))(numOps, opList, flags, stream)
    }
    ...
    pub unsafe fn cudaMemDiscardBatchAsync(
        ...
        (self
            .cudaMemDiscardBatchAsync
            .as_ref()
            .expect("Expected function, got error."))(dptrs, sizes, count, flags, stream)
    }
    ...
    pub unsafe fn cudaMemGetDefaultMemPool(
        ...
        (self
            .cudaMemGetDefaultMemPool
            .as_ref()
            .expect("Expected function, got error."))(memPool, location, type_)
    }
    ...
    pub unsafe fn cudaMemSetMemPool(
        ...
        (self
            .cudaMemSetMemPool
            .as_ref()
            .expect("Expected function, got error."))(location, type_, memPool)
    }
    ...
    pub unsafe fn cudaGraphKernelNodeCopyAttributes(
        ...
        (self
            .cudaGraphKernelNodeCopyAttributes
            .as_ref()
            .expect("Expected function, got error."))(hDst, hSrc)
    }
